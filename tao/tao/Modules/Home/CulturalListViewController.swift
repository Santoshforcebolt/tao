//
//  CulturalListViewController.swift
//  tao
//
...
class CulturalListViewController: BaseViewController<CulturalListViewModel> {
    var navigationBar: UINavigationBar?
    var transactionCollectionView: UICollectionView
    
    override init(_ viewModel: CulturalListViewModel) {
...
extension CulturalListViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
