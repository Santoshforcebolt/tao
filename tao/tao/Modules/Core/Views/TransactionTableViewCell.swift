...
class TransactionTableViewCell: UITableViewCell {
    ...
    private var textTitleLabel: UILabel = {
    ...
    func setupView() {
        ...
        if self.showCounter {
            horizontalStackView.addArrangedSubview(self.textTitleLabel)
            self.textTitleLabel.setContentHuggingPriority(.required, for: .horizontal)
            self.textTitleLabel.widthAnchor.constraint(equalToConstant: 32).isActive = true
        }
