...
- (CGFloat)getFactor:(CGFloat *)fadeMax fadeMin:(CGFloat *)fadeMin fadeMinAlpha:(CGFloat *)fadeMinAlpha fadeRange:(CGFloat *)fadeRange offset:(CGFloat)offset {
...
- (CGFloat)alphaForItemWithOffset:(CGFloat)offset
{
    ...
    CGFloat factor = [self getFactor:&fadeMax fadeMin:&fadeMin fadeMinAlpha:&fadeMinAlpha fadeRange:&fadeRange offset:offset];
